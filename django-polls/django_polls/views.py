...
from django_polls.models import Question, Choice, Grade, Difficulty
...
class ResultsView(generic.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        choices_with_pct = []
        for c in choices:
            pct = int(round((c.votes / total_votes) * 100)) if total_votes > 0 else 0
            choices_with_pct.append({'choice': c, 'pct': pct})
